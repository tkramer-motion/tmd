...
from tmd.constants import DEFAULT_CHIRAL_ATOM_RESTRAINT_K
from tmd.fe.dummy import canonicalize_bond
from tmd.fe.utils import get_romol_conf
from tmd.graph_utils import convert_to_nx, enumerate_simple_paths
from tmd.potentials.chiral_restraints import U_chiral_atom_batch, pyramidal_volume, torsion_volume
...
def xs_ab_from_xs(xs: NDArray, atom_map):
    ...
    atom_map: tmd.fe.single_topology.AtomMapMixin
    ...
    from tmd.fe.cif_writer import convert_single_topology_mols
...
def make_chiral_flip_heatmaps(simulation_result, atom_map):
    ...
    Parameters
    ----------
    simulation_result: tmd.fe.free_energy.SimulationResult
