...
class SingleTopologyREST(SingleTopology):
    r"""Extends :py:class`tmd.fe.single_topology.SingleTopology` to enhance intermediate states with REST-like
    ...
    def combine_with_host(
        ...
        ref_state = super().combine_with_host(host_system, lamb, num_water_atoms, omm_topology)
        ...
        #
        # However, (2) and (3) were incompatible with the previous water sampling implementation, which assumed that the
